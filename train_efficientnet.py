...
CHECKPOINT_DIR  = os.path.join(PROJECT_DIR, "checkpoints", "efficientnet")
OUTPUT_DIR      = os.path.join(PROJECT_DIR, "outputs", "efficientnet")
BEST_MODEL_PATH = os.path.join(PROJECT_DIR, "best_models", "efficientnet_best.pth")

PRETRAINED_MODEL = os.path.join(PROJECT_DIR, "pretrained", "efficientnet_food_classification.pth")
...
if os.path.exists(PRETRAINED_MODEL):
    ...
    # Drop classifier weights that don't match current num_classes
    checkpoint = {
